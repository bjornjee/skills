...
| Model | ID | Best For |
|-------|-----|----------|
| Fable 5 | `claude-fable-5` | Latest frontier model — hardest reasoning and agentic tasks |
...
Default to Sonnet 4.6 unless the task requires deep reasoning (Opus/Fable) or speed/cost optimization (Haiku). For production, prefer pinned snapshot IDs over aliases — verify current IDs at docs.anthropic.com before shipping.
