...
4. Create branch `refactor/<name>` and worktree `../worktrees/<app>/<name>` from origin/main:
   `mkdir -p ../worktrees/<app> && git worktree add ../worktrees/<app>/<name> -b refactor/<name> origin/main`
