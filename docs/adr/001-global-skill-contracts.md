...
Consumers: marketplace users must refresh the package; UI verdict readers must adopt raw scores, null scores with score_exceptions, separate p3_findings, explicit tradeoffs, and parent-owned budget reporting.
